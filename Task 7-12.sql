...
-- 8. Создание таблиц из диаграммы.
...
-- 9. Заполнение низкоуровневых таблиц именами, командами и датами рождения.
...
-- 10. Удаление верблюдов. Объединение оставщихся.
...
-- 11. Создание таблицы молодых животных, старше 1 года, но моложе 3х лет.
